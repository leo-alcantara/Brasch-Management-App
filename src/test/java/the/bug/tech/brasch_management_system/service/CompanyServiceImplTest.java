...
class CompanyServiceImplTest {
    ...
    void should_get_company_by_project_name_return_list() {
        ...
        List<Company> foundCompany;
        //Act
        foundCompany = companyService.getCompanyByProjectNameContainsIgnoreCase("Rebuild Globen");
        //Assert
        //assertEquals(1, foundCompany.size());
        assertTrue(foundCompany.contains(denzel));
    }
    ...
    void should_get_company_by_contact_person_name_return_list() {
        ...
        List<Company> foundCompany;
        //Act
        foundCompany = companyService.getCompanyByContactPersonContainsIgnoreCase("Denzel");
        //Assert
        assertEquals(1, foundCompany.size());
