...
class ProjectManagerServiceImplTest {
    ...
    void getProjectManagerByNameContainsIgnoreCase() {
        ...
        //Act
        foundManagers = projectManagerService.getProjectManagerByNameContainsIgnoreCase("Jimmy");
        //Assert
        assertEquals(1, foundManagers.size());
        assertTrue(foundManagers.contains(jimmy));
    }
    ...
    void getProjectManagerByProjectContainsIgnoreCase() {
        ...
        List<ProjectManager> foundManagers;
        //Act
        foundManagers = projectManagerService.getProjectManagerByProjectContainsIgnoreCase("Rebuild");
        //Assert
        assertFalse(foundManagers.isEmpty());
        assertTrue(foundManagers.contains(jimmy));
        assertEquals("Jimmy Fallon", foundManagers.stream().findFirst().get().getProjectManagerPerson().getPersonName());
    }
}